...
export const BGReplace: FC<IconProps> = ({ ...props }) => {
  return (
    <SvgIcon {...props}>
      <svg
...
export const CenterFocus: FC<IconProps> = ({ ...props }) => {
  return (
    <SvgIcon {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const FilterFrame: FC<IconProps> = ({ ...props }) => {
  return (
    <SvgIcon {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const PhotoLib: FC<IconProps> = ({ ...props }) => {
  return (
    <SvgIcon {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
